...
class LoginWindow:
    ...
    def setup_ui(self):
        ...
        # Logo
        logo_label = tk.Label(
            card, text="🔐", font=("Helvetica", 28), bg="white", fg=PRIMARY_COLOR
        )
        logo_label.pack(pady=(0, 10))

        # Title
        tk.Label(
            card, text="Welcome Back!", font=TITLE_FONT, bg="white", fg=TEXT_COLOR
        ).pack(pady=(0, 5))
        tk.Label(
            card,
        ...
        # Login button
        login_btn = tk.Button(
            card, text="Login", command=self.login_user, **BUTTON_STYLE
        )
